...
},{"../adapters/http":2,"../adapters/xhr":2,"../core/AxiosError":8,"../helpers/normalizeHeaderName":25,"../helpers/toFormData":30,"../utils":32,"./env/FormData":26,"./transitional":16,"_process":38}],16:[function(require,module,exports){
'use strict';
...
},{"../utils":32,"buffer":36}],31:[function(require,module,exports){
'use strict';
  ...
  categoryData.forEach(category => {
    rawHTML += `
      <tr>
        ...
        <td>${category.id}</td>
        <td>${category.name}</td>
        <td>${category.productAmount || 0}</td>     
        <td>
          <div class='dropdown'>
            <button
              class='btn'
